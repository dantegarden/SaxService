...
public class MyFirefoxDirver extends FirefoxDriver {
	private Capabilities mycapabilities;

	public MyFirefoxDirver(String localserver, String sessionID) {
	...
	protected void mystartClient(String localserver) {
		...
		try {
			...
			System.out.println("can not connect"
					+ delegate.getAddressOfRemoteServer() + "  and  "
					+ delegate);
		}
	}
	...
	protected void mystartSession(String sessionID) {
		...
		Map<String, Object> rawCapabilities = (Map<String, Object>) response
				.getValue();
		DesiredCapabilities returnedCapabilities = (DesiredCapabilities) super
				.getCapabilities();
		...
		String platformString = (String) rawCapabilities
				.get(CapabilityType.PLATFORM);
		Platform platform;
		try {
